...
# while recording
env = retro.make('SonicTheHedgehog-Genesis', 'GreenHillZone.Act1', record='./record/')
...
# When it reaches the end of the map, terminate
            if xpos_screen == xpos_end and xpos > 500:
...
p = neat.Checkpointer.restore_checkpoint('neat-checkpoint-12') # Restore the progress and train from there
